...
public class ConflictOrderingSearchTest {
    ...
    public void testStampIt1() throws Exception {
        ...
        Assert.assertEquals(cos.prev.getInt(0), -1);
        Assert.assertEquals(cos.next.getInt(0), -1);
        ...
        Assert.assertEquals(cos.prev.getInt(0), -1);
        Assert.assertEquals(cos.next.getInt(0), 1);
        Assert.assertEquals(cos.prev.getInt(1), 0);
        Assert.assertEquals(cos.next.getInt(1), -1);
        ...
        Assert.assertEquals(cos.next.getInt(0), 1);
        Assert.assertEquals(cos.prev.getInt(1), 0);
        Assert.assertEquals(cos.next.getInt(1), 2);
        Assert.assertEquals(cos.prev.getInt(2), 1);
        Assert.assertEquals(cos.next.getInt(2), -1);
        ...
        Assert.assertEquals(cos.next.getInt(1), 2);
        Assert.assertEquals(cos.prev.getInt(2), 1);
        Assert.assertEquals(cos.next.getInt(2), 3);
        Assert.assertEquals(cos.prev.getInt(3), 2);
        Assert.assertEquals(cos.next.getInt(3), -1);
        Assert.assertEquals(cos.pcft, 3);
        cos.stampIt(mvars[0]);
        Assert.assertEquals(cos.vars.size(), 4);
        Assert.assertEquals(cos.prev.getInt(1), -1);
        Assert.assertEquals(cos.next.getInt(1), 2);
        Assert.assertEquals(cos.prev.getInt(2), 1);
        Assert.assertEquals(cos.next.getInt(2), 3);
        Assert.assertEquals(cos.prev.getInt(3), 2);
        Assert.assertEquals(cos.next.getInt(3), 0);
        Assert.assertEquals(cos.prev.getInt(0), 3);
        Assert.assertEquals(cos.next.getInt(0), -1);
        Assert.assertEquals(cos.pcft, 0);
        cos.stampIt(mvars[3]);
        Assert.assertEquals(cos.vars.size(), 4);
        ...
        Assert.assertEquals(cos.next.getInt(1), 2);
        Assert.assertEquals(cos.prev.getInt(2), 1);
        Assert.assertEquals(cos.next.getInt(2), 0);
        Assert.assertEquals(cos.prev.getInt(0), 2);
        Assert.assertEquals(cos.next.getInt(0), 3);
        Assert.assertEquals(cos.prev.getInt(3), 0);
        Assert.assertEquals(cos.next.getInt(3), -1);
        Assert.assertEquals(cos.pcft, 3);
    }
